...
module.exports = function(particleName,options) {
  ...
  var helper = function(cModule,pPath,hArgs,hOpts,cOpts) {
    ...
    if (hOpts.fn) {
      templateContent = processTemplate(hOpts.fn,hOpts,cOpts,{},data,extended);
    }
    ...
    if (pPath) {
      ...
      mergeParticleTemplate = processTemplate(fn,hOpts,cOpts,m,pData,extended);
    }
...
var processTemplate = function(fn,hOpts,cOpts,m,data,extended) {
