...
module.exports = function(s3opts,distPath,awsS3) {
  ...
  templateData.s3.condensationUrl = url.parse([awsS3.endpoint.href,path.posix.join(s3opts.aws.bucket,s3opts.prefix)].join(''));
  ...
  .pipe(function() {
    var doValidate = (s3opts.validate || process.env.FORCE_VALIDATE) ? true : false;
    return gulpif(
      doValidate,
